...
def home(x,y):
    ...
    turtle.color("Cyan")
    turtle.goto(0,0)
    turtle.write("Play", font=(1000))
    turtle.title("SnakeGame")
...
def start(x,y):
    ...
    while x > -210 and x < 210 and y > -210 and y <210:
        ...
        if x > foodcoord[0]*20-5 and x < foodcoord[0]*20+5 and y > foodcoord[1]*20-5 and y < foodcoord[1]*20+5:
            ...
            tscore.clear()
            tscore.write("Score:" + str(a[0]), align="center",font=(10))
            if x >  bigFoodcoord[0]*20-5 and x < bigFoodcoord[0]*20+5 and y > bigFoodcoord[1]*20-5 and y < bigFoodcoord[1]*20+5:
                foodcoord[2] = 0
                tfood.clear()
                bFood.clear()
                a[0] += 5
